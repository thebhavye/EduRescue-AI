/*
 * REAL React Bits "ParticleText" component.
 * Source: https://github.com/DavidHDev/react-bits/blob/main/src/content/TextAnimations/ParticleText/ParticleText.jsx
 * (MIT + Commons Clause — vendored here, converted from JSX to TypeScript
 * without changing behaviour; only types were added.)
 * No external dependency beyond React.
 */
